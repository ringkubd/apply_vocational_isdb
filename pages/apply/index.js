                    ...
                    <fieldset className="border-2 p-4 mb-4 shadow hover:shadow-2xl rounded group  shadow-cyan-500/50 hover:shadow-[#05a0c8]">
                        ...
                        <div className="-mx-3 md:flex mb-6">
                            ...
                            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="text" name="gpa" required id="passing_year" className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" />
                            </div>
                        </div>
                    </fieldset>
                    <fieldset className="border-2 p-4 shadow hover:shadow-2xl mb-4 rounded group  shadow-cyan-500/50 hover:shadow-[#05a0c8]">
                        ...
                        <div className="-mx-3 md:flex mb-6">
                            ...
                            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <select ref={currentStudyingLevel} disabled={true} name="studying_level" required id="studying_level" className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3">
                                    <option value="VIII">VIII</option>
                                    <option value="JSC">JSC</option>
                                    <option value="JDC">JDC</option>
                                    <option value="SSC">SSC</option>
                    ...
                    <fieldset className="border-2 p-4 shadow hover:shadow-2xl mb-4 rounded group  shadow-cyan-500/50 hover:shadow-[#05a0c8]">
                        ...
                        <div className="-mx-3 md:flex mb-6">
                            ...
                            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input type="tel" name="guardian_number" required id="guardian_number" className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3" />
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset className="border-2 p-4 shadow hover:shadow-2xl mb-4 rounded group  shadow-cyan-500/50 hover:shadow-[#05a0c8]">
                        ...
                        <div className="-mx-3 md:flex mb-6">
                            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input className='w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3' name="permanent_address" id='permanent_address' />
                            </div>
                            <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <input name="district" required id="district" className="w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-1 relative" ref={districtInput} onKeyUp={onDistrictSearch} />
                    ...
                    <fieldset className="border-2 p-4 shadow hover:shadow-2xl mb-4 rounded group  shadow-cyan-500/50 hover:shadow-[#05a0c8]">
                        ...
                        <div className="-mx-3 md:flex mb-6">
                            <div className="md:w-full px-3 mb-6 md:mb-0">
                                ...
                                <label htmlFor="same_as_permanent" className="text-xs border-2 p-1 border-cyan-200">Same as Permanent <input type="checkbox" ref={same_as_permanent} id="same_as_permanent" className="rounde"/></label>
                                <textarea ref={presentAddress} className='w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3' name="present_address" id='present_address'></textarea>
                            </div>
                            <div className="md:w-full px-3 mb-6 md:mb-0">
                                ...
                                <textarea className='w-full bg-gray-200 text-black border border-gray-200 rounded py-3 px-4 mb-3' name="reference" id='reference' placeholder="Name, Designation, Contact Number, Address"></textarea>
                            </div>
                        </div>
                    </fieldset>
